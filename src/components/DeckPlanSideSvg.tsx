...
// 좌표계는 평면 뷰와 동일한 viewBox 0 0 2000 850, 뱃머리=오른쪽(두 뷰 모두 동일 방향 유지).
// side='port'  → 좌현에서 본 내부(후방 좌현 선실, 후방 헤드, 살롱 세틀리, 오너 선실)
// side='starboard' → 우현에서 본 내부(후방 우현 선실, 갤리, 항해석, 전방 헤드, 오너 선실)
//
...
export default function DeckPlanSideSvg({ side }: Props) {
      ...
      {isPort ? (
        ...
        <g>
          ...
          <g fill="#94a3b8" fontSize="15" textAnchor="middle" stroke="none">
            <text x="360" y="352">콕핏</text>
            <text x="400" y="446">후방 선실</text>
            <text x="690" y="396">헤드</text>
            <text x="1070" y="392">살롱</text>
            <text x="1480" y="428">오너 선실</text>
          </g>
        </g>
      ) : (
        /* ===== 우현 내부 ===== */
        <g>
          ...
          <g fill="#94a3b8" fontSize="15" textAnchor="middle" stroke="none">
            <text x="360" y="352">콕핏</text>
            <text x="400" y="446">후방 선실</text>
            <text x="700" y="396">갤리</text>
            <text x="1070" y="392">살롱</text>
            <text x="1320" y="418">항해석</text>
            <text x="1560" y="428">오너 선실</text>
          </g>
        </g>
      )}
