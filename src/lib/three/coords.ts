...
export const SECTIONS: Section[] = [
  ...
  },
  {
    key: "owner",
    label: "오너 선실",
    camera: { position: [7.3, 3.3, 4.5], target: [4.7, -0.15, 0] },
    interior: true,
    range: [2.3, 7.9],
  },
  {
    key: "saloon",
    label: "살롱",
    camera: { position: [2.9, 3.6, 4.6], target: [0.7, -0.15, 0] },
    interior: true,
    range: [-1.0, 2.35],
  },
  {
    key: "galley",
    label: "갤리/헤드",
    camera: { position: [-0.9, 3.5, 4.6], target: [-2.7, -0.15, 0] },
    interior: true,
    range: [-4.4, -0.95],
  },
  {
    key: "aft",
    label: "후방 선실",
    camera: { position: [-3.9, 3.1, 4.5], target: [-6.2, -0.1, 0] },
    interior: true,
    range: [-8.5, -4.4],
  },
  {
